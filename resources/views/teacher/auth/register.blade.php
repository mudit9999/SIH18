                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/teacher/register') }}">
                            ...
                            <div class="form-group{{ $errors->has('teacher_id') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">Teacher No.</label>

                                <div class="col-md-6">
                                    <input id="teacher_id" type="text" class="form-control" name="teacher_id"
                                           value="{{ old('teacher_id') }}" autofocus>

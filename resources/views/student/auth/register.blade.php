                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/student/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('student_id') ? ' has-error' : '' }}">
                            <label for="student_id" class="col-md-4 control-label">Student No.</label>
                        ...
                        <div class="form-group{{ $errors->has('sem') ? ' has-error' : '' }}">
                            <label for="student_id" class="col-md-4 control-label">Semster</label>

                            <div class="col-md-6">
                                <input id="sem" type="text" class="form-control" name="sem" value="{{ old('sem') }}">
